    ...
    if ($(document).find('.nft-column').length !== 0) {
      $(document).find('.nft-column').each(function() {
        ...
        let result = async () => {
          ...
          if($('.drop-single-wrap').hasClass('added')) {

          } else {
            if(parseInt(unclaimed) > 0) {
              $('.drop-single-wrap').find('.nft-counter-info-item').removeClass('w-condition-invisible');
              $('.drop-single-wrap').find('.nft-sale-over-wrap').addClass('w-condition-invisible');
            } else {
              $('.drop-single-wrap').find('.nft-counter-info-item').addClass('w-condition-invisible');
              $('.drop-single-wrap').find('.nft-sale-over-wrap').removeClass('w-condition-invisible');
            }
            $('.drop-single-wrap').addClass('added');
          }
